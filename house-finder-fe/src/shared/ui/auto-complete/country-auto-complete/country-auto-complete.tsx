...
import {Autocomplete, Box, createTheme, TextField, ThemeProvider} from "@mui/material";
import {CountryAutoCompleteProps} from "../auto-complete-props.ts";

export const CountryAutoComplete = ({onSearchChange,mode,width,countries,selectedCountry}: CountryAutoCompleteProps) => {
    ...
    const bg = mode === 'dark' ? 'rgba(26, 28, 29,0.99) !important' : '#ffffff !important'
    const border = mode === 'dark' ? '2px solid rgba(255, 255, 255, 0.2) !important' : '1px solid hsl(225, 50%, 48%) !important'
    const color = mode === 'dark' ? '#f5f8f2 !important' : 'black'
    const colorLetters = mode === 'dark' ? 'white' : 'black !important'
    const bgListbox = mode === 'dark' ? 'rgba(26, 28, 29,0.99)' : 'white !important'
