...
export const SignInPage = () => {
  ...
  return (
    <div
      className={`container-sign ${animateCircles ? 'animate-circles' : ''}`}
    >
      ...
      <form
        className={`sign-in-form ${animateForm ? 'animate-form' : ''}`}
      ...
      >
        ...
        <button className={'forgot-link'} onClick={handleOpen}>
        ...
        <div className='social'>
          ...
          <div className='fb icon'>
            <BiLogoFacebookCircle color={'#4066ff'} size={25} />
            Facebook
          </div>
        </div>
        <Modal
