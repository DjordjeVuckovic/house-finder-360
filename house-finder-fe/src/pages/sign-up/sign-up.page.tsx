...
export const SignUpPage = () => {
  ...
  return (
    <div
      className={`container-sign-up ${animateCircles ? 'animate-circles-up' : ''}`}
    >
      <div
        className={`background-up ${animateCircles ? 'animate-circles-up' : ''}`}
      >
        <div className='shape-up'></div>
        <div className='shape-up'></div>
      </div>
      <form
        className={`sign-up-form ${animateForm ? 'animate-form' : ''}`}
      ...
      >
        ...
        <FormControl>
          ...
          />
          {errors.phone?.message && <FieldError error={errors.phone.message} />}
        </FormControl>
        <div className={'row'}>
