    ...
    <div className={'nav-container'}>
      <div className={'nav-top'}>
        ...
        <div className={'nav-link'}>
          <NavLink url={'sale'}>
            ...
            <span className={'orange-text-small'}>
              {' '}
              ({userProperties?.forSales.length || 0}){' '}
            </span>
          </NavLink>
        </div>
        <div className={'nav-link'}>
          <NavLink url={'rent'}>
            ...
            <span className={'orange-text-small'}>
              {' '}
              ({userProperties?.forRent.length || 0}){' '}
            </span>
          </NavLink>
        </div>
      </div>
      <div className={'properties'}>
        <Routes>
          <Route
            path={'/all-properties'}
            element={<SingleUserProperties properties={allProperties} />}
          />
          <Route
            path={'/sale'}
            element={
              <SingleUserProperties
                properties={userProperties?.forSales || []}
              />
            }
          />
          <Route
            ...
            element={
              <SingleUserProperties
                properties={userProperties?.forRent || []}
              />
            }
          />
        </Routes>
