            ...
            <div className={'padding-base inner-width flex-center value-container'}>
                ...
                <div className={'flex-col-start value-right'}>
                    <span className={'orange-text'}
                          data-aos="fade-left"
                          data-aos-duration="3000">Our Value</span>
                    <span className={'primary-text'}
                          data-aos="fade-right"
                          data-aos-duration="3000">Value We Give to You <span className={'orange-text-large'}>.</span>
                    </span>
        ...
        <Accordion allowMultipleExpanded={false}
                   ...
                   data-aos-duration="3500">
            {
                homeValueData.map((item) => {
                    return (
                        <AccordionItem className={`v-accordion-item expanded`}
                                       key={item.id}
                                       uuid={item.id}>
                            <AccordionItemHeading>
