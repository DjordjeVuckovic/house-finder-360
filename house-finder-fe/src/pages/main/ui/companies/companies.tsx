    ...
    return (
        <section className={'companies-wrapper'}>
            <div className="padding-base flex-center companies-container">
                <img src={c1} alt={'logo'} data-aos="fade-right" data-aos-duration="3500"/>
                <img src={c2} alt={'logo'} data-aos="fade-right" data-aos-duration="3500"/>
                <img src={c3} alt={'logo'} data-aos="fade-left" data-aos-duration="3500"/>
                <img src={c4} alt={'logo'} data-aos="fade-left" data-aos-duration="3500"/>
            </div>
        </section>
    );
};
