import {Address, AddressRequest, SaleProperty, SalePropertyRequest} from "../model/property.ts";

export function mapSalePropertyToRequest(saleProperty: SaleProperty): SalePropertyRequest {
    return {
