...
public abstract class EventSourcedEntity<T> : Entity<T> where T : notnull
{
    private EventSourcedAggregateRoot<T>? _root;
    ...
    public virtual void Initialize(EventSourcedAggregateRoot<T> root)
    {
